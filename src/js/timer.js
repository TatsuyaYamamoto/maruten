...
export default class Timer{
    constructor(limit, callback){
        ...
        // サブタイトル
        this._subtitleText = new createjs.Text("のこり", `bold ${unitTextSize}px Arial`, "#FFFFFF");
        ...
        // 秒数
        this._timeText = new createjs.Text("", `bold ${timeTextSize}px Arial`, "#FFFFFF");
        ...
        // 単位
        this._unitText = new createjs.Text("びょう", `bold ${unitTextSize}px Arial`, "#FFFFFF");
